...
import com.app.videodownloadappv1hurricandev.model.WebConnect;
import com.app.videodownloadappv1hurricandev.download.frag.DownloadsC;
import com.google.android.material.bottomnavigation.BottomNavigationView;
import com.app.videodownloadappv1hurricandev.browser.BrowserManager;
import com.app.videodownloadappv1hurricandev.download.frag.Downloads;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, TextView.OnEditorActionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                browserManager.newWindow("https://www.facebook.com/watch");
            }
        });
